      ...
      >
        <button
          ...
          className={`
            ...
            ${!isDisabled ? "hover:bg-gray-100 hover:border-[2px] hover:border-[#000] text-gray-900 cursor-pointer" : "text-gray-300 cursor-not-allowed"}
            ${isSelected ? "bg-black text-white hover:bg-gray-800 border-2 border-black" : ""}
