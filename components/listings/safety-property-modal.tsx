    ...
    >
      <div className="space-y-6">
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-600">
                CCTV Security Cameras installed by the building entrance.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-gray-600">
                Just one flight of stairs to access the apartment.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-sm text-gray-700 leading-relaxed">
          We don't have a drive way or garage, but you can find street parking in the area.
          You can visit{" "}
          <a
            href="https://www.justpark.com/uk/parking/marylebone"
            target="_blank"
